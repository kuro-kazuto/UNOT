...
public class PreviewCreate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pque.setText(getIntent().getStringExtra("que"));
        ...
        btnCreateQ.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SoalAModel soalAModel = new SoalAModel(id, q, ca, o1, o2, o3, o4);

                databaseReference.child(soalAModel.getId()).setValue(soalAModel);
