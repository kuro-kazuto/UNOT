...
public class TugasAkhirActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    qrFab.setOnClickListener(view -> {
      Intent intent = new Intent(TugasAkhirActivity.this, QrTool.class);
    ...
    btnHome.setOnClickListener(new View.OnClickListener() {
      String url = "http://ta.untirta.ac.id/"; //Change URL
      @Override
      public void onClick(View v) {
        webView.loadUrl(url);
        swipe.setRefreshing(true);
    ...
    btnClose.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        deleteCookies();
        Intent i = new Intent(TugasAkhirActivity.this, MainActivity2.class);
